...
////topic ////////////////////////////////////////////////////
    ...
    { 
     ...
     //   ARX_ARM.is_torque_control = true;
      ...
      //  ARX_ARM.ros_control_pos[2] = ARX_ARM.ros_control_pos[2]+0.001;
      //  std::cout<<" ros_message = "<<ARX_ARM.ros_control_pos[2]<<std::endl;
      // ARX_ARM.

     //  cmd.control_z = cmd.control_z+0.01;
...
////topic ////////////////////////////////////////////////////
        ...
        std::cout<<" msg_pos_back.z="<<msg_pos_back.z<<std::endl;
